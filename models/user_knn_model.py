...
def train_model(trainset):
    """
    Entrena un modelo User-Based KNN.
    """
    print("2. Entrenando el modelo User-Based KNN...")
    # Opciones de similitud: 'cosine', 'msd', 'pearson'
...
def generate_predictions(model, antitest_set):
    ...
    """
    print("3. Generando predicciones con User-Based KNN...")
...
if __name__ == "__main__":
    ...
    print("\n--- Proceso del modelo User-Based KNN finalizado ---")
